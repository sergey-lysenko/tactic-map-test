...
public class OfFractions extends AbstractRanger<Fraction> {
     ...
     * @param actual      A map associating Fraction keys with ActualFraction values representing the actual fractions.
     ...
     */
    public OfFractions(final ValidationMeta meta, final Map<Fraction, ActualFraction> actual,
