...
public interface _GridProcessor {
     ...
     */
    Map<Fraction, ActualFraction> getBrightnessesByRates(_FractionQuotas brightnesses);
    ...
    Map<Integer, ActualFraction> getColoursByRates();
     ...
     */
    Map<Integer, ActualFraction> getColoursByRates(Fraction threshold);
     ...
     * @return a map containing the pixel values as keys and their corresponding rates as values 0.0 .. 1.0
     */
    Map<Integer, ActualFraction> getColoursByRates(final Fraction threshold, final IgnoreHSB ignoreHSB);
     ...
     */
    Map<Fraction, ActualFraction> getHuesByRates(_FractionQuotas hues);

    /**
     * Retrieves the saturations by rates for a given SharesOfSaturation object.
     *
     * @param saturations the SharesOfSaturation object for which to retrieve the saturations by rates
     * @return a map containing the pixel values as keys and their corresponding saturations as fractions
     */
    Map<Fraction, ActualFraction> getSaturationsByRates(_FractionQuotas saturations);
}
