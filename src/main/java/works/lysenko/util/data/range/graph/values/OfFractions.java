...
public record OfFractions() {
     ...
     */
    public static Fraction actualValuesFromMapFraction(final String title, final Map<Fraction, ValuedRangeResult> shares,
        ...
        for (final Map.Entry<Fraction, ValuedRangeResult> sorted : shares.entrySet())
